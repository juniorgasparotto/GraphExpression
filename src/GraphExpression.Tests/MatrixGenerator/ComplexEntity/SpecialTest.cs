...
namespace GraphExpression.Tests.MatrixGenerator
{
    public class SpecialTest
    {
        ...
        public void CreateCircularAnNonCircularGraph_ReturnExpressionAsString()
        {
            ...
            var expected = $"\"{a.GetType().Name}.{a.GetHashCode()}\" + \"A_PropString: Value\" + (\"A_PropB.{a.A_PropB.GetHashCode()}\" + \"B_PropString: B_Value\" + \"A_Circular.{a.A_PropB.A_Circular.GetHashCode()}\" + (\"A_NonCircular.{a.A_PropB.A_NonCircular.GetHashCode()}\" + \"A_PropString\" + \"A_PropB\"))";
