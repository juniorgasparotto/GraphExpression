...
namespace ExpressionGraph.Reflection
{
    public class Instance
    {
        ...
        public List<IPropertyRead> PropertyReaders { get; private set; }
        public List<IMethodRead> MethodReaders { get; private set; }

        public Instance(object obj, string name = null)
        {
            if (obj == null)
            ...
            this.PropertyReaders = new List<IPropertyRead>();
            this.PropertyReaders.Add(new PropertyReadDefault());
            this.PropertyReaders.Add(new PropertyReadIndexerIList());

            this.MethodReaders = new List<IMethodRead>();
            this.MethodReaders.Add(new MethodReadDefault());
        }
        ...
        {
            var props = InstanceTypes.SelectMany(f => f.Properties);
        ...
        {
            var methods = InstanceTypes.SelectMany(f => f.Methods);
        ...
        private void ParseProperties(InstanceType instanceType, List<Property> propertiesAddeds)
        {
            ...
            foreach (var property in properties)
            {
                ...
                var propertyAux = new Property(name, objType, property, values);
