...
namespace ExpressionGraph.Tests
{
    ...
    public class TestGraph
    {
        ...
        {
            var vertexesSources = ExpressionUtils.FromString("A+(B+C+D)+D+(E+B)+F+G(G+G+C)+(H+C)");
            var graphs = vertexesSources.ToGraphs(f => f.Children);
            var graphsClean = graphs.RemoveCoexistents();
        ...
        {
            var debug = ExpressionUtils.FromString("A+(B+C+D)+D+(E+B)+F+G(G+G+C)+(H+C)").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + C + D) + D + (E + (B + C + D)) + F + (G + G + C) + (H + C)" == debug);
            debug = ExpressionUtils.FromString("A+A").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + A" == debug);
            debug = ExpressionUtils.FromString("A+B+A").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + B + A" == debug);
            debug = ExpressionUtils.FromString("A+(B+A)").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + A)" == debug);
            debug = ExpressionUtils.FromString("A+(B+B+A)").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + B + A)" == debug);
            debug = ExpressionUtils.FromString("A+(B+A(B+A))").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + A + B)" == debug);
            debug = ExpressionUtils.FromString("A+(B+A)+B+A").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + A) + (B + A) + A" == debug);
            debug = ExpressionUtils.FromString("A+(B+A)+A+B").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + A) + A + (B + A)" == debug);
            debug = ExpressionUtils.FromString("A+(B+A)+A+(C+B)").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + A) + A + (C + (B + A))" == debug);
            debug = ExpressionUtils.FromString("A+(B+A)+(I+A+D+B+D)+(C+B)").ToGraphs(f => f.Children).ElementAt(0).ToString();
            Assert.IsTrue("A + (B + A) + (I + A + D + (B + A) + D) + (C + (B + A))" == debug);
        }
