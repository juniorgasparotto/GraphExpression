...
namespace EntityGraph.Converter
{
    ...
    public class HierarchicalEntityToToken
    {
        ...
        public HierarchicalEntityToToken(Func<object, string> viewFunc, TokenizeType typeReading = TokenizeType.Normal)
        {
        ...
        {
            var list = new List<HierarchicalEntity>();
            list.Add(entity);
            var graphs = list.ToGraphs(f => f.Children);
        ...
        {
            var graphs = listToConvert.ToGraphs(f => f.Children);
